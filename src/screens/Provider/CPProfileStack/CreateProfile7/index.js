...
function index({ navigation }) {
  ...
  const submitChoices = () => {
    const ansCollection = firestore().collection('SearchProviders').doc('6').collection('Answers')
    for (const choice in experience) {
  ...
  return (
    <ScreenView style = {styles.container}>
      ...
      <ScreenView style = {styles.card}>
        <Text style = {styles.description} h4>How many years of work experience do you have?</Text>
