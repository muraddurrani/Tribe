...
function index({ navigation }) {
  ...
  const submitChoices = () => {
    const ansCollection = firestore().collection('SearchProviders').doc('4').collection('Answers')
  ...
  return (
    <ScreenView style = {styles.container}>
      ...
      <ScreenView style = {styles.card}>
        <Text style = {styles.description} h4>At which times are you available?</Text>
