...
function index({ navigation }) {
  ...
  const submitChoices = () => {
    const ansCollection = firestore().collection('SearchProviders').doc('1').collection('Answers')
  ...
  return (
    <ScreenView style = {styles.container}>
      ...
      <ScreenView style = {styles.card}>
        <Text style = {styles.description} h4>Do you offer individual or group sessions?</Text>
